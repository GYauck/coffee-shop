  ...
  return (
    <div className={style.aboutUsContainer}>
      ...
      <div className={style.ourCommitmentContainer}>
        <img className={style.ourCommitmentImg} src={images.desktop['image-commitment']} alt="image-commitment" />
      ...
      <div className={style.qualityContainer}>
        ...
        <img className={style.qualityImg} src={images.desktop['image-quality']} alt="image-quality" />
      </div>
